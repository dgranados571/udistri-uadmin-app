                        ...
                        <div className='div-login'>
                            <div className='div-login-elements'>
                                <div className='div-elements-children' >
                                    <p className=''>A travez de la zona transaccional podra hacer seguimiento y gestión a todas las solicitudes</p>
                ...
                <div className="row mt-3">
                    <div className="col-12 col-sm-12 col-md-12 col-lg-12">
                        <div className='div-login'>
                            <div className='div-login-elements'>
                                <div className='div-elements-children' >
                                    <p>Para activar tu cuenta debes actualizar la contraseña</p>
                                    <div className='div-inputs-login'>
