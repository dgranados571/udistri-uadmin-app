...
const ZoneContractual = ({ setRedirect, toast, setCargando }) => {
            ...
            case 'MENU1':
                return (
                    <div className='div-container'>
                          <Solicitudes toast={toast} setCargando={setCargando} zonaConsulta= 'ZoneContractual' />
                    </div>
                )
            case 'MENU2':
                return (
...
export default ZoneContractual